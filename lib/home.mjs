...
<section class="band status-band">
  <div class="wrap narrow">
    ...
    <p>
      What is reachable today: the schema is served from the URL that identifies it, as
      <code>application/schema+json</code> with permissive CORS and immutable caching, so you can
      <code>$ref</code> it by URL. The package is published as
      <a href="https://www.npmjs.com/package/@open-predicate/open-predicate" rel="noopener"><code>@open-predicate/open-predicate</code></a>
      if you would rather vendor the file. Pin the versioned <code>$id</code> either way — it never
      moves, and an unversioned one does not exist.
    </p>
    <p class="muted">
